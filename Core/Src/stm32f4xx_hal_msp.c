...
void HAL_PCD_MspInit(PCD_HandleTypeDef* hpcd)
{
  ...
  if(hpcd->Instance==USB_OTG_HS)
  {
    ...
    */
    GPIO_InitStruct.Pin = ULP_STP_Pin|ULPI_DIR_Pin|ULPI_NXT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    ...
    GPIO_InitStruct.Pin = ULPI_D0_Pin|ULPI_CLK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF10_OTG_HS;
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* hpcd)
{
  if(hpcd->Instance==USB_OTG_HS)
  {
    ...
    PB5     ------> USB_OTG_HS_ULPI_D7
    */
    HAL_GPIO_DeInit(GPIOC, ULP_STP_Pin|ULPI_DIR_Pin|ULPI_NXT_Pin);

    HAL_GPIO_DeInit(GPIOA, ULPI_D0_Pin|ULPI_CLK_Pin);

    HAL_GPIO_DeInit(GPIOB, ULPI_D1_Pin|ULPI_D2_Pin|ULPI_D3_Pin|ULPI_D4_Pin
                          |ULPI_D5_Pin|ULPI_D6_Pin|ULPI_D7_Pin);
